 ...
 * @property {boolean} [reverseDirection=false] - Флаг, изменяет порядок перебора элементов списка. Значение по умолчанию - false (перебор объектов с первого до последнего), значение true - с последнего до первого.
 */
